"""
Django settings for odd_star_dev_74040 project.
...
ROOT_URLCONF = 'odd_star_dev_74040.urls'
...
WSGI_APPLICATION = 'odd_star_dev_74040.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_star_dev_74040 API",
    "DESCRIPTION": "API documentation for odd_star_dev_74040 App",
    "VERSION": "v1",
}
